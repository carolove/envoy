#include "extensions/filters/network/dubbo_proxy/filters/ratelimit/config.h"
...
DubboProxy::DubboFilters::FilterFactoryCb
RateLimitFilterConfig::createFilterFactoryFromProtoTyped(
  ...
  return [proto_config, &context, timeout,
          config](DubboProxy::DubboFilters::FilterChainFactoryCallbacks& callbacks) -> void {
 ...
 */
REGISTER_FACTORY(RateLimitFilterConfig, DubboProxy::DubboFilters::NamedDubboFilterConfigFactory);
